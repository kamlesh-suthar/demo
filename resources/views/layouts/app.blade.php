                    ...
                    @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                        @if(\Illuminate\Support\Facades\Session::has($msg))
                            <p class="alert alert-{{ $msg }}">
                                {{ \Illuminate\Support\Facades\Session::get($msg) }} <a href="#" class="close" data-dismiss="alert" aria-label="close" style="float: right; color: #0f5132; text-decoration: none">&times;</a>
                            </p>
                        @endif
                    @endforeach
                </div>
